...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	/** Table View */
	tableViewWindow = [[OBMenuBarWindow alloc] initWithContentRect:b styleMask:NSTitledWindowMask | NSClosableWindowMask | NSResizableWindowMask backing:NSBackingStoreBuffered defer:NO];
    ...
    tableViewWindow.highlightedMenuBarIcon = [NSImage imageNamed:@"MenuBarIcon2"];
    tableViewWindow.hasMenuBarIcon = YES;
    tableViewWindow.attachedToMenuBar = YES;
